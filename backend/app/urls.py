...
urlpatterns = [
    ...
    path('users/<int:profile_id>/delete/', delete_user),
    path('users/donors/<int:profile_id>/approve-disapprove/', approve_disapprove_donor),
    path('users/donors/', get_donors),
    path('users/beneficiaries/', get_beneficiaries),
    ...
    path('financial-requests/<int:request_id>/delete/', delete_financial_request),
